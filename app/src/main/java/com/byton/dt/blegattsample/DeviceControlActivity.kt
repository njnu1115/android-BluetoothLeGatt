...
class DeviceControlActivity : Activity() {
    ...
    private val _listName = "NAME"
    private val _listUUID = "UUID"
    ...
    public override fun onCreate(savedInstanceState: Bundle?) {
        ...
        this.findViewById<TextView>(R.id.device_address).text = mDeviceAddress
        mGattServicesList = this.findViewById(R.id.gatt_services_list)
    ...
    private fun displayGattServices(gattServices: List<BluetoothGattService>?) {
        ...
        for (gattService in gattServices) {
            ...
            currentServiceData[_listName] = SampleGattAttributes.lookup(uuid, unknownServiceString)
            currentServiceData[_listUUID] = uuid
            ...
            for (gattCharacteristic in gattCharacteristics) {
                ...
                currentCharaData[_listName] = SampleGattAttributes.lookup(uuid, unknownCharaString)
                currentCharaData[_listUUID] = uuid
